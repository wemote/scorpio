package com.wemote.scorpio.modules.test.log;
...
public class LogbackListAppenderTest {
    ...
    public void addAndRemoveAppender() {
        ...
        // name
        appender.clearLogs();
        appender.addToLogger("com.wemote.scorpio.modules.test.log");
        logger.warn(testString);
        assertThat(appender.getFirstLog()).isNotNull();

        appender.clearLogs();
        appender.removeFromLogger("com.wemote.scorpio.modules.test.log");
        logger.warn(testString);
        assertThat(appender.getFirstLog()).isNull();
    }
}
